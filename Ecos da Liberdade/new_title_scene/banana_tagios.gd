...
const START_LEVEL : String = "res://Levels/Ecos/01.tscn"

@export var music : AudioStream
@export var button_focus_audio : AudioStream
@export var button_press_audio : AudioStream

@onready var button_new: Button = $Control/ButtonNew
@onready var button_continue: Button = $Control/ButtonContinue
@onready var button_exit: Button = $Control/ButtonExit
